...
export default function Dashboard() {
  ...
  return (
    <div className="relative bg-[#fdfdff] min-h-screen flex">
      ...
      {/* Sidebar */}
      <div
        className={`fixed inset-y-0 left-0 w-[220px] text-white shadow-lg transform transition-transform duration-300 ${
      ...
      {/* Main Content - Ensures visibility with extra padding */}
